...
while ($row = mysqli_fetch_assoc($results)) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        echo '
        <div class="button-container">
        <form method="POST" action="view_itemdetails.php" style="display:inline;">
            <input type="hidden" name="action" value="view_details">
            <button type="submit" class="item_details_disabled">View Details</button>
        </form>
    
        <form method="POST" action="view_cart.php" style="display:inline;">
            <input type="hidden" name="action" value="add_to_cart">
            <button type="submit" class="add_to_cart_disabled">Add to Cart</button>
        </form>
        </div>';
