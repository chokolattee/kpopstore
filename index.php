...
while ($row = mysqli_fetch_assoc($results)) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        <form action="cart_update.php" method="POST" style="display:inline;">
            ...
            echo '
            <button type="button" class="item_details_disabled" onclick="window.location.href=\'/kpopstore/user/login.php\'">View Details</button>';
    
            echo '
            <button type="button" class="add_to_cart_disabled" onclick="window.location.href=\'/kpopstore/user/login.php\'">Add to Cart</button>';
